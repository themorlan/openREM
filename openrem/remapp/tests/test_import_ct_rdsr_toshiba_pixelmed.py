...
class ImportCTRDSRFromPixelMed(TestCase):
    ...
    def test_import_toshiba_from_pixelmed(self):
        ...
        self.assertEqual(
            ...
            "Oxbridge County Hospital",
        )
        self.assertEqual(
            study.generalequipmentmoduleattr_set.get().manufacturer, "TOSHIBA"
        )
        ...
        self.assertAlmostEqual(
            study.patientstudymoduleattr_set.get().patient_age_decimal, Decimal(42.9)
        )
    ...
    def test_import_ge_from_pixelmed(self):
        ...
        self.assertAlmostEqual(
            study.patientstudymoduleattr_set.get().patient_age_decimal, Decimal(100.0)
        )
