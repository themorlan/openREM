...
class ImportCTRDSR(TestCase):
    ...
    def test_import_ct_rdsr_siemens(self):
        ...
        self.assertEqual(
            ...
            "Hospital Number One Trust",
        )
        self.assertEqual(
            study.generalequipmentmoduleattr_set.get().manufacturer, "SIEMENS"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            study.generalequipmentmoduleattr_set.get().station_name, "CTAWP00001"
        )
        ...
        self.assertAlmostEqual(
            study.patientstudymoduleattr_set.get().patient_age_decimal, Decimal(67.6)
        )

        # Test that irradiation time data is stored correctly
        self.assertEqual(
            study.ctradiationdose_set.get().start_of_xray_irradiation,
            datetime.datetime(1997, 1, 1, 0, 6, 31, 737000),
        )
        self.assertEqual(
            study.ctradiationdose_set.get().end_of_xray_irradiation,
            datetime.datetime(1997, 1, 1, 0, 9, 47, 950000),
        )
        self.assertEqual(
            study.ctradiationdose_set.get().procedure_reported.code_meaning,
            "Computed Tomography X-Ray",
        )
        self.assertEqual(
            study.ctradiationdose_set.get().has_intent.code_meaning, "Diagnostic Intent"
        )
        self.assertEqual(
            study.ctradiationdose_set.get().source_of_dose_information.code_meaning,
        ...
        self.assertEqual(
            study.ctradiationdose_set.get()
            .observercontext_set.get()
            .device_observer_physical_location_during_observation,
            "Hospital Number One Trust",
        )
        self.assertEqual(
            study.ctradiationdose_set.get()
        ...
        self.assertEqual(
            study.ctradiationdose_set.get().scope_of_accumulation.code_meaning, "Study"
        )
        ...
        self.assertAlmostEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .nominal_single_collimation_width,
            Decimal(0.6),
        )
        self.assertAlmostEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .nominal_total_collimation_width,
            Decimal(3.6),
        )
        self.assertEqual(
            study.ctradiationdose_set.get()
        ...
        self.assertEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .ct_acquisition_type.code_meaning,
        ...
        self.assertAlmostEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .ctxraysourceparameters_set.get()
            .kvp,
            Decimal(120),
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .procedure_context.code_meaning,
            "CT without contrast",
        )
        self.assertAlmostEqual(
            study.ctradiationdose_set.get()
        ...
        self.assertEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .ctdiw_phantom_type.code_meaning,
    ...
    def test_import_ct_rdsr_siemens_dual_source(self):
        ...
        self.assertAlmostEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .ctxraysourceparameters_set.order_by("identification_of_the_xray_source")[0]
            .kvp,
            Decimal(100),
        )
        self.assertAlmostEqual(
            study.ctradiationdose_set.get()
            .ctirradiationeventdata_set.order_by("id")[0]
            .ctxraysourceparameters_set.order_by("identification_of_the_xray_source")[1]
            .kvp,
            Decimal(140),
        )
