...
def _radiopharmaceutical_administration_event_data(dataset, radiopharmaceutical_dose):
    ...
    for cont in dataset.ContentSequence:
        if (
            ...
            _person_participant(
                cont, "radiopharmaceutical_administration_event_data", rad_event
            )
...
def rdsr(rdsr_file):
    ...
    if (
        ...
        dataset.SOPClassUID == "1.2.840.10008.5.1.4.1.1.88.68"
        and dataset.ConceptNameCodeSequence[0].CodeValue == "113500"
    ):
