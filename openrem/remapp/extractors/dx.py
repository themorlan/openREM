...
def _xray_filters_prep(dataset, source):
    ...
    if xray_filter_material and "," in xray_filter_material and not isinstance(xray_filter_material, MultiValue):
    ...
    if xray_filter_thickness_minimum and not isinstance(xray_filter_thickness_minimum, (MultiValue, list)):
        try:
    ...
    if xray_filter_thickness_maximum and not isinstance(xray_filter_thickness_maximum, (MultiValue, list)):
        try:
