...
class CalcExpMap(object):
    ...
    def __init__(self, phantom_type=None, pat_pos=None,
        ...
        if self.phantom_type == 'flat':
            ...
            self.phantom = geomclass.Phantom3([0, -5, -self.matt_thick], mass=self.pat_mass,
                                              height=self.pat_height, pat_pos=pat_pos)
    ...
    def add_view(self,
        ...
        if 'Rotational' in run_type:
            ...
            self.my_dose.add_dose(skinMap.skinMap(x_ray, self.phantom, area, ref_ak, kvp, filter_cu, d_ref,
                                                  self.table_length, self.table_width,
                                                  self.table_trans,
                                                  self.table_thick + self.matt_thick))
