...
from . import views, views_admin, views_charts_ct, views_charts_dx, views_charts_mg, views_charts_rf
...
main_patterns = [
    ...
    path("rf/chart/", views_charts_rf.rf_summary_chart_data, name="rf_summary_chart_data"),
    path(
        "rf/<int:pk>/skin_map/",
