...
urlpatterns = [
    ...
    url(r'^admin/review/studiesequipdelete$', views.review_studies_equip_delete,
        name='review_studies_equip_delete'),
    url(r'^admin/review/failed/(?P<modality>\w+)/$', views.review_failed_imports,
        name='review_failed_imports'),
    url(r'^admin/review/failed/study$', views.review_failed_study_details,
        name='review_failed_study_details'),
    url(r'^admin/review/studiesdeletefailed$', views.review_failed_studies_delete,
    ...
    url(r'^admin/dicomstore/(?P<pk>\d+)/delete/$', views.DicomStoreDelete.as_view(),
