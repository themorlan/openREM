...
class RadiopharmaceuticalRadiationDose(models.Model):  # TID 10021
    ...
    associated_procedure = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10021_procedure',
        on_delete=models.CASCADE)  # CID 3108
    has_intent = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10021_intent',
        on_delete=models.CASCADE)  # CID 3629
    comment = models.TextField(blank=True, null=True)


class LanguageofContentItemandDescendants(models.Model):  # TID 1204
    radiopharmaceutical_radiation_dose = models.ForeignKey(RadiopharmaceuticalRadiationDose, on_delete=models.CASCADE)
    language_of_contentitem_and_descendants = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid1204_language',
        on_delete=models.CASCADE)  # CID 5000
    country_of_language = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid1204_country',
...
class RadiopharmaceuticalAdministrationEventData(models.Model):  # TID 10022
    ...
    radiopharmaceutical_agent = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10022_agent', on_delete=models.CASCADE)  # CID 25 & CID 4021
    radionuclide = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10022_radionuclide', on_delete=models.CASCADE)  # CID 18 & CID 4020
    ...
    pre_activity_measurement_device = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10022_device_pre', on_delete=models.CASCADE)  # CID 10041
    ...
    post_activity_measurement_device = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10022_device_post', on_delete=models.CASCADE)  # CID 10041
    route_of_administration = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10022_route', on_delete=models.CASCADE)  # CID 11
    site_of = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10022_site', on_delete=models.CASCADE)  # CID 3746
    laterality = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10022_laterality', on_delete=models.CASCADE) # CID 244
...
class BillingCode(models.Model):
     radiopharmaceutical_administration_event_data = models.ForeignKey(RadiopharmaceuticalAdministrationEventData,
        on_delete=models.CASCADE)
     billing_code = models.ForeignKey(ContextID, blank=True, null=True, on_delete=models.CASCADE)


class DrugProductIdentifier(models.Model):
     radiopharmaceutical_administration_event_data = models.ForeignKey(RadiopharmaceuticalAdministrationEventData,
        on_delete=models.CASCADE)
     drug_product_identifier = models.ForeignKey(ContextID, blank=True, null=True, on_delete=models.CASCADE)
...
class OrganDose(models.Model):  # TID 10023
    ...
    finding_site = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10023_site', on_delete=models.CASCADE) # CID 10044
    laterality = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10023_laterality', on_delete=models.CASCADE) # CID 244
    ...
    reference_authority_code = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10023_authority', on_delete=models.CASCADE)  # CID 10040
...
class RadiopharmaceuticalAdministrationPatientCharacteristics(models.Model):
    ...
    subject_sex = models.ForeignKey(ContextID, blank=True, null=True, related_name='tid10023_sex', on_delete=models.CASCADE)  # CID 7455
    ...
    body_surface_area_formula = models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10023_body_surface_area', on_delete=models.CASCADE)  # CID 3663
    body_mass_index = models.DecimalField(max_digits=16, decimal_places=8, blank=True, null=True)
    equation =  models.ForeignKey(
        ContextID, blank=True, null=True, related_name='tid10023_equation', on_delete=models.CASCADE)
...
class PatientState(models.Model):  # CID 10045
    radiopharmaceutical_administration_patient_characteristics = models.ForeignKey(RadiopharmaceuticalAdministrationPatientCharacteristics,
        on_delete=models.CASCADE)
    patient_state = models.ForeignKey(ContextID, blank=True, null=True, on_delete=models.CASCADE)
